...
- Opción para **enseñar nuevos personajes** cuando el sistema falla.
- Base de datos persistente en archivo JSON (`onepiece_chars.json`).
- Dataset inicial con personajes como: *Luffy, Zoro, Nami, Sanji, Chopper, Brook, Franky, Trafalgar Law, Shanks*, entre otros.
